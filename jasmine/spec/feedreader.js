...
$(function () {
    ...
    */
    describe('RSS Feeds', function () {
         ...
         * page?
         * //all of the headlines are gone and no specs pass
         */
        ...
        it('URLs are defined', function () {
            for (let eachFeed of allFeeds) {
                //for of loop was used. each is arbitrary(any variable could have been used here)
    ...
    */
         ...
         */
        it('changes visibility/toggles', function () {
            const body = document.querySelector('body');
